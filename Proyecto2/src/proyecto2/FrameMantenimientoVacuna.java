 ...
 * @author Marcos
 */
public class FrameMantenimientoVacuna extends javax.swing.JFrame {
    ...
    public FrameMantenimientoVacuna() throws ClassNotFoundException, SQLException {
        initComponents();
    ...
    public void correr() {
        String principal[] = {"Código de Vacuna", "Descripción"};
        String datos[][] = {};
    ...
    public void llenar() {
        codVacuna.setText((String) modelo.getValueAt(0, 0));
    ...
    public void Select() {
        ...
        String descrip = "";
        try {
            ResultSet datos = CP.select("*", "\"schProyecto\".\"vacuna\"", "");
            while (datos.next()) {
    ...
    private void initComponents() {
        ...
        getContentPane().add(codVacuna, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 250, 70, -1));
    ...
    private void okActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okActionPerformed
        if (tipo == 1) {
            String datos = "";
            datos = "('" + this.codVacuna.getText() + "','"
                    + this.descripcion.getText() + "')";
            this.CP.insertar("\"schProyecto\".vacuna", datos);
            codVacuna.setEditable(false);
            descripcion.setEditable(false);
            correr();
        } else if (tipo == 2) {
            ...
            estado = this.CP.modificar("\"schProyecto\".vacuna", datos);
            codVacuna.setEditable(false);
            descripcion.setEditable(false);
            this.correr();
        } else if (tipo == 3) {
            String estado;
            String datos;
            datos = " where cod_vacuna = " + "'" + this.codVacuna.getText() + "'";
            estado = this.CP.borrar("\"schProyecto\".vacuna", datos);
            correr();
            codVacuna.setText("");
            descripcion.setText("");
        }
    ...
    private void tablaDueñoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaDueñoMouseClicked
        codVacuna.setText((String) modelo.getValueAt(tablaDueño.getSelectedRow(), 0));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrameMantenimientoVacuna.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new FrameMantenimientoVacuna().setVisible(true);
                } catch (ClassNotFoundException ex) {
                    Logger.getLogger(FrameMantenimientoVacuna.class.getName()).log(Level.SEVERE, null, ex);
